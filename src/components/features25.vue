            ...
            <h2 class="thq-heading-2">
              <slot name="feature1Title">
                ...
                <div class="features25-fragment4">
                  <span class="features25-text4">Teacher Dashboard</span>
                </div>
              </slot>
            </h2>
              ...
              <slot name="feature1Description">
                ...
                <div class="features25-fragment2">
                  <span class="features25-text2">
                    Access student performance charts and report tools
                  </span>
                </div>
              </slot>
            </span>
              ...
              <slot name="feature2Description">
                ...
                <div class="features25-fragment5">
                  <span class="features25-text5">
                    Students have access to customized learning paths
                  </span>
                </div>
              </slot>
            </span>
            ...
            <h2 class="thq-heading-2">
              <slot name="feature3Title">
                ...
                <div class="features25-fragment6">
                  <span class="features25-text6">Quiz Progress and Rewards</span>
                </div>
              </slot>
            </h2>
            <span class="thq-body-small">
              <slot name="feature3Description">
                ...
                <div class="features25-fragment1">
                  <span class="features25-text1">
                    Track quiz progress and earn rewards for achievements
                  </span>
                </div>
              </slot>
            </span>
...
export default {
  ...
  props: {
    feature1ImgAlt: {
      type: String,
      default: 'Image of Teacher Dashboard',
    },
    feature3ImgAlt: {
      type: String,
      default: 'Image of Quiz Progress and Rewards',
    },
    feature1ImgSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1513151233558-d860c5398176?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0Nzg4MTE2OHw&ixlib=rb-4.1.0&q=80&w=1080',
    },
    feature3ImgSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1649257942551-8b319aa74c25?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0Nzg4MTE2OHw&ixlib=rb-4.1.0&q=80&w=1080',
    },
    feature2ImgAlt: {
      type: String,
      default: 'Image of Personalized Learning Paths',
    },
    feature2ImgSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1486746730710-0e7ce7b07038?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0Nzg4MTE2OHw&ixlib=rb-4.1.0&q=80&w=1080',
    },
  },
  data() {
    return {
