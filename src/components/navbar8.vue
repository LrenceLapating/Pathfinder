<template>
  <header class="navbar8-container1">
    <header data-thq="thq-navbar" class="navbar8-navbar-interactive">
      <div class="navbar8-logo-container" style="display: flex; align-items: center;">
        <img :alt="logoAlt" :src="logoSrc" class="navbar8-image1" />
        <span class="navbar8-logo-text" style="margin-left: 10px; font-size: 1.5rem; font-weight: bold;">Pathfinder</span>
      </div>
        ...
        <nav class="navbar8-links1">
          ...
          <a :href="link2Url" class="thq-link thq-body-small">
            <slot name="link2">
              ...
              <div><span>Teacher Dashboard</span></div>
            </slot>
          </a>
          <a
            :href="link3Url"
          ...
          >
            <slot name="link3">
              ...
              <div><span>Student Dashboard</span></div>
            </slot>
          </a>
          <div
      ...
      <div data-thq="thq-mobile-menu" class="navbar8-mobile-menu">
        <div class="navbar8-nav">
          <div class="navbar8-top">
            <div class="navbar8-logo-container-mobile" style="display: flex; align-items: center;">
              <img :alt="logoAlt" :src="logoSrc" class="navbar8-logo" />
              <span class="navbar8-logo-text-mobile" style="margin-left: 10px; font-size: 1.5rem; font-weight: bold;">Pathfinder</span>
            </div>
            ...
            <a :href="link2Url" class="thq-link thq-body-small">
              <slot name="link2">
                ...
                <div class="navbar8-fragment12">
                  <span class="navbar8-text16">Teacher Dashboard</span>
                </div>
              </slot>
            </a>
            <a :href="link3Url" class="navbar8-link32 thq-link thq-body-small">
              <slot name="link3">
                <!--Default content for link3-->
                <div class="navbar8-fragment20">
                  <span class="navbar8-text24">Student Dashboard</span>
                </div>
              </slot>
            </a>
                ...
                <span class="thq-link thq-body-small">
                  <slot name="link4">
                    ...
                    <div class="navbar8-fragment17">
                      <span class="navbar8-text21">Reports</span>
                    </div>
                  </slot>
                </span>
                ...
                <span class="navbar8-page12 thq-body-large">
                  <slot name="page1">
                    ...
                    <div class="navbar8-fragment13">
                      <span class="navbar8-text17">Page One</span>
                    </div>
                  </slot>
                </span>
                <span class="thq-body-small">
                  <slot name="page1Description">
                    ...
                    <div class="navbar8-fragment18">
                      <span class="navbar8-text22">Page One Description</span>
                    </div>
                  </slot>
                </span>
              </div>
                ...
                <span class="navbar8-page22 thq-body-large">
                  <slot name="page2">
                    ...
                    <div class="navbar8-fragment16">
                      <span class="navbar8-text20">Page Two</span>
                    </div>
                  </slot>
                </span>
                <span class="thq-body-small">
                  <slot name="page2Description">
                    ...
                    <div class="navbar8-fragment19">
                      <span class="navbar8-text23">Page Two Description</span>
                    </div>
                  </slot>
                </span>
              </div>
                ...
                <span class="navbar8-page32 thq-body-large">
                  <slot name="page3">
                    ...
                    <div class="navbar8-fragment21">
                      <span class="navbar8-text25">Page Three</span>
                    </div>
                  </slot>
                </span>
                <span class="thq-body-small">
                ...
                <span class="navbar8-page42 thq-body-large">
                  <slot name="page4">
                    ...
                    <div class="navbar8-fragment15">
                      <span class="navbar8-text19">Page Four</span>
                    </div>
                  </slot>
                </span>
                <span class="thq-body-small">
                  <slot name="page4Description">
                    ...
                    <div class="navbar8-fragment10">
                      <span class="navbar8-text14">Page Four Description</span>
                    </div>
                  </slot>
                </span>
              </div>
...
.navbar8-logo-container:hover {
  transform: translateY(-2px);
}

.navbar8-logo-container-mobile {
  display: flex;
  align-items: center;
}
</style>
