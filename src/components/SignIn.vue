...
export default {
  ...
  methods: {
    ...
    checkAndRenderGoogleButton() {
      console.log('Checking and rendering Google button...');
      
      // Check if Google API is already loaded
      if (window.google && window.google.accounts) {
        console.log('Google API is loaded, rendering button');
        this.googleScriptLoaded = true;
        this.renderGoogleButton();
      } else {
        console.log('Google API not loaded yet, trying to load it');
        ...
        setTimeout(() => {
          if (window.google && window.google.accounts) {
            console.log('Google API loaded after delay, rendering button');
            this.googleScriptLoaded = true;
            this.renderGoogleButton();
          } else {
            console.warn('Google API still not available after delay');
            const buttonElement = document.getElementById('google-signin-button');
            if (buttonElement) {
